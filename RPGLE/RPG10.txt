0001.00 FSUBF5     CF   E             WORKSTN SFILE(SFLRCD:RRN)
...
0011.02 C     *loval        setll     COMPOFF             
0011.03 C                   read      COMPOFF             
0011.04 C                   dow       not %eof(COMPOFF)   
0011.05 C                   CLEAR                   SFLRCD
0011.06 C                   eval      $EMPID=EMPID        
0011.07 C                   eval      $WRKDATE=WRKDATE    
0011.08 C                   eval      $DAYTYPE=DAYTYPE    
0011.09 C                   IF        STATUS='A'        
0011.10 C                   eval      $STATUS='A'       
0011.11 C                   ELSEIF    STATUS='D'        
0011.12 C                   eval      $STATUS='D'       
0011.13 C                   ELSE                        
0011.15 C                   eval      $STATUS=''        
0011.16 C                   endif                       
...
0040.17 C                   if        OPT=1 OR OPT=2  
0040.18 C                   exsr      load1           
0040.19 C                   endif                     
0040.20 C                   IF        OPT=5           
0040.22 C                   exsr      viewdesc  
0040.23 C                   endif               
0040.24 C                   eval      OPT=*zeros
...
0041.02 C     EMPID         CHAIN     COMPOFF        
0043.00 C                   if        %found(COMPOFF)
0044.00 C                   if        OPT=1          
0045.00 C                   eval      STATUS='A' 
0046.00 C                   elseif    OPT=2      
...
0053.03 C     EMPID         CHAIN     COMPOFF            
0054.00 C                   IF        %FOUND(COMPOFF)    
0055.00 C                   EVAL      $EMPID1=EMPID      
0055.01 C                   EVAL      $WRKDATE1=WRKDATE  
0055.02 C                   EVAL      $DAYTYPE1=DAYTYPE  
0055.03 C                   EVAL      $REASON1=REASON    
0055.04 C                   EVAL      $PRJCTID1=PRCTID  
0055.05 C     EMPID         CHAIN     EMPMASTER         
0055.06 C                   IF        %FOUND(EMPMASTER) 
0056.00 C                   EVAL      $EMPNAME1=EMPNAME 
0056.01 C                   ENDIF                       
0061.00 C                   ENDIF                       
0061.01 C                   DOW       *IN03=*OFF        
0062.00 C                   EXFMT     VIEWDESC12        
0062.01 C                   if        $OPT1=1           
0062.02 C                   eval      $STATUS1='A'    
0062.03 C                   elseif    $OPT1=2         
0062.04 C                   eval      $STATUS1='D'    
0062.05 C                   endif                     
0062.06 C     EMPID         CHAIN     COMPOFF         
0062.07 C                   IF        %FOUND(COMPOFF) 
